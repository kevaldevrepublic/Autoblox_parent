...
public class test3 extends keywords 
{
	  ...
	  {
		  /*System.setProperty("webdriver.chrome.driver", "D:\\Devrepublic\\Keval\\Data\\Selenium\\selenium-java-2.52.0\\chromedriver_win32\\chromedriver.exe");
								...
								//  System.out.println(img1);
								  Thread.sleep(5000);
									...
									boolean present;
												...
												if( inner_HTML.contains("CodeB.OK.gif")/* || inner_HTML.contains("DocsO.NOK.gif")*/)
													 {
														present = false;
