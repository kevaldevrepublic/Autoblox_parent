...
public class Dev59_Cardocs_point_7 extends keywords 
{

	private static String baseUrl;
	private boolean acceptNextAlert = true;
	private static StringBuffer verificationErrors = new StringBuffer();
	final static Logger logger = Logger.getLogger(Dev59_Cardocs_point_7.class);
	...
	public void login_test_suit() throws Exception 
	{
		try{    
		  ...
		  Thread.sleep(20000);*/
			...
			Thread.sleep(5000);
			setUp();
			Dev59_Cardocs_point_7 obj = new Dev59_Cardocs_point_7();
			obj.login_test_suit();
